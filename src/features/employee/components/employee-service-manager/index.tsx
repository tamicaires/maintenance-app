...
import { CircleFadingPlus, Search, X } from "lucide-react";
import { cn } from "@/lib/utils";
import { EmployeeBasicInfo } from "@/shared/types/employee.interface";
import { useAddEmployeeToServiceAssignment } from "@/features/service-assigment/hooks/use-add-service-employee";
import { useEmployee } from "@/features/employee/hooks/use-employee";
import { Select as CustomSelect } from "../../../../components/custom-combobox";
...
export default function EmployeeServiceManager({
  employees,
  onAddEmployee,
  size = "md",
  serviceAssignmentId,
  ...
  const { submitAddEmployeeData, isPending } =
    useAddEmployeeToServiceAssignment();
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              <div className="flex flex-col items-center gap-4 border-b border-muted">
                <div className="flex ">
                  <Label htmlFor="add-person" className="pt-1">
